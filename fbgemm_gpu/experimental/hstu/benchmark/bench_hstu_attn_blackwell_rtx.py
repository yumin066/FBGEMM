#!/usr/bin/env python3
"""
Blackwell RTX HSTU Attention Benchmark.
...
Usage:
    python benchmark/bench_hstu_attn_blackwell_rtx.py
    python benchmark/bench_hstu_attn_blackwell_rtx.py --mode kernel
    python benchmark/bench_hstu_attn_blackwell_rtx.py --mode e2e
    python benchmark/bench_hstu_attn_blackwell_rtx.py --mode all
    python benchmark/bench_hstu_attn_blackwell_rtx.py --seqlens 512 1024 2048 4096
    python benchmark/bench_hstu_attn_blackwell_rtx.py --mode kernel --mask-configs all --bias-configs all
    python benchmark/bench_hstu_attn_blackwell_rtx.py --mode kernel --mask-configs full causal --bias-configs none rab
    python benchmark/bench_hstu_attn_blackwell_rtx.py --mode kernel --columns fp8 paged
"""
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Blackwell RTX HSTU Attention Benchmark (BF16 vs FP8 block-scale)"
    )
    parser.add_argument(
        "--mode",
