...
// SM120 (Blackwell consumer) BF16/FP16 HSTU forward kernel body.
// Launch dispatch lives in hstu_fwd_kernel_launch.h.
...
template <typename Kernel_traits, typename Params>
__global__ void hstu_fwd_kernel_sm120_bf16(Params params) {
